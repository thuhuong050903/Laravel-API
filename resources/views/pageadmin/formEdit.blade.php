    ...
    <div class="container">
        <form action="admin-edit" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="number" min=0 class="form-control" name="editNew" id="editNew" value="{{$product->new}}"
                    placeholder="Enter new" required>
            </div>

            <div class="form-group">
                <label for='editType'>Type</label>
                <input type="text" class="form-control" name="editType" id="editType" value="{{$product->id_type}}"
